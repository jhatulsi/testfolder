    	...
    	<div class="InnerLeftWrap">
            ...
            <p><strong>Home Design PVT LTD</strong></p>
             ...
             <div class="enqieryWrap clearfix">
                ...
                <input name="mobile" id="mobile" class="enqieryinput" type="text" maxlength="12" onblur="this.placeholder = 'Contact Number'" onkeyup="checkNum(this);" onblur="checkNum(this);" onfocus="this.placeholder = ''" placeholder="Contact Number" /><br>
                ...
                <div id="INPROCESS"><button class="" value="" name="submit" >Submit</button></div>
                </form> 
                </div>
