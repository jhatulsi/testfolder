...
if(isset($_GET['added_products'])){ ?>
		<table align="center" width="794" bgcolor="#FFCC99">
			...
			<?php 
				...
				$get_pro = "select * from products where status='off'";
			...
			<td><a href="approve_products.php?appr_products=<?php echo $p_id; ?>">Approve</a> / <a href="approve_products.php?disappr_products=<?php echo $p_id; ?>" id="dis_appr">Disapprove</a> </td>
		</tr>
		<?php 
