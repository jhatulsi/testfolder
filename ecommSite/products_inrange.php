...
<div id="mainContainer">
  ...
  <header>
    <div class="wrapper">
      ...
      <div id="logo">
        ...
        <a id="cart" href="messageeb96.html" class="hidden-mobile"><img src="assets/templates/black-eagle-html5-premium/images/cart.png"><span id="noItems">3</span> <span id="noItemsText">Item</span>, <span id="cartlink">View Cart</span></a>
        <div class="clear"></div>
    </div>
    <div class="clear"></div>
  </header>
  ...
  <div class="wrapper">
    ...
    <!--END: LEFT BAR-->
  <div id="mainContent"><section id="searchGroup"> 
  <!--START: BODY_HEADER-->
  <div class="breadcrumbs"><a href='index.html'>Home</a> > <a href="products_byprice_1-1-1.html">$0 - $24.99</a></div>
  <!--END: BODY_HEADER-->
  <h1 class="page_headers">$0 - $24.99</h1>
  <!--START: MANUFACTURER_HEADER--><!--END: MANUFACTURER_HEADER--> 
  <!--START: ITEMS-->
  <div id="itemsBlock">
    <div class="products-header"><span class="hidden-mobile">Products </span><span class="hidden-mobile">(</span>Total Items: 6<span class="hidden-mobile">)</span>
      <div class="sort-by"><!--START: sortbylist-->
        <form action="http://blackeagle-preview-com.3dcartstores.com/search_groups.asp?keyword=1&amp;manf=0&amp;byprice=1" method="post" name="frmsortby">
          Sort by:
          <select name="sortby" onchange="frmsortby.submit();">
          	<option value="0">Order By</option><option value="1" selected>Price: Low to High</option><option value="2">Price: High to Low</option><option value="3">Name</option><option value="4">Newest</option><option value="13">Avg Review</option>
          </select>
        </form>
        <!--END: sortbylist-->
        <div class="clear"></div>
    ...
    <div class="product-item item-template-0 alternative">
        <div class="img"><a href="Mirage-Black-Leather-Belt_p_13.html"><img src="assets/images/belts_thumbnail.jpg" alt="Mirage Black Leather Belt" id="qv_13" /></a></div>
        <div class="name"><a href="Mirage-Black-Leather-Belt_p_13.html">Mirage Black Leather Belt</a></div>
        <div class="stars">
        <!--START: product_review--> 
        <!--START: product_review_average-->
        ...
        <span class="hidden">Your Price:&nbsp;</span>$12.99
        <!--END: ITEMPRICE--> 
        </div>
        <div class="status"><!--START: product_availability-->Back Order. <!--END: product_availability--></div>
        <div class="action">
            <input type="button" value="Add To Cart" onclick="window.location = 'Mirage-Black-Leather-Belt_p_13.html?quick=1&amp;item_id=13'" class="btn" onmouseover="this.className='btn_over'" onmouseout="this.className='btn'" />
        </div>
    <div class="clear"></div>
    </div>
    </div><div class="product-container middle-item">
    <div class="product-item item-template-0 alternative">
        <div class="img"><a href="Billy-The-Kid-Leather-Jacket_p_12.html"><img src="assets/images/vest_thumbnail.jpg" alt="Billy The Kid Leather Jacket" id="qv_12" /></a></div>
        <div class="name"><a href="Billy-The-Kid-Leather-Jacket_p_12.html">Billy The Kid Leather Jacket</a></div>
        <div class="stars">
        <!--START: product_review--> 
        <!--START: product_review_average-->
            <img src="assets/templates/common-html5/images/star0.png" alt="Average Rating" /><span>(0)</span>
        ...
        <div class="status"><!--START: product_availability-->Back Order. <!--END: product_availability--></div>
        <div class="action">
            <input type="button" value="Add To Cart" onclick="window.location = 'Billy-The-Kid-Leather-Jacket_p_12.html?quick=1&amp;item_id=12'" class="btn" onmouseover="this.className='btn_over'" onmouseout="this.className='btn'" />
        </div>
    <div class="clear"></div>
    </div>
    </div><div class="product-container last-item">
    <div class="product-item item-template-0 alternative">
        <div class="img"><a href="Heavy-Duty-Leather-Boots_p_6.html"><img src="assets/images/ladyboots_thumbnail.jpg" alt="Heavy Duty Leather Boots" id="qv_6" /></a></div>
        <div class="name"><a href="Heavy-Duty-Leather-Boots_p_6.html">Heavy Duty Leather Boots</a></div>
        <div class="stars">
        <!--START: product_review--> 
        <!--START: product_review_average-->
            <img src="assets/templates/common-html5/images/star0.png" alt="Average Rating" /><span>(0)</span>
        ...
        <div class="status"><!--START: product_availability-->Back Order. <!--END: product_availability--></div>
        <div class="action">
            <input type="button" value="Add To Cart" onclick="window.location = 'Heavy-Duty-Leather-Boots_p_6.html?quick=1&amp;item_id=6'" class="btn" onmouseover="this.className='btn_over'" onmouseout="this.className='btn'" />
        </div>
    <div class="clear"></div>
    </div>
    </div><div style="clear: both;"></div></div><div class="productBlockContainer columns-3"><div class="product-container first-item">
    <div class="product-item item-template-0 alternative">
        <div class="img"><a href="Texana-Leather-Boots_p_4.html"><img src="assets/images/boots_thumbnail.jpg" alt="Texana Leather Boots" id="qv_4" /></a></div>
        <div class="name"><a href="Texana-Leather-Boots_p_4.html">Texana Leather Boots</a></div>
        <div class="stars">
        <!--START: product_review--> 
        <!--START: product_review_average-->
            <img src="assets/templates/common-html5/images/star0.png" alt="Average Rating" /><span>(0)</span>
        ...
        <div class="action">
            <input type="button" value="Add To Cart" onclick="window.location = 'view_cart509f.html?quick=1&amp;item_id=4'" class="btn" onmouseover="this.className='btn_over'" onmouseout="this.className='btn'" />
        </div>
    <div class="clear"></div>
    </div>
    </div><div class="product-container middle-item">
    <div class="product-item item-template-0 alternative">
        <div class="img"><a href="Sport-Leather-Jacket_p_1.html"><img src="assets/images/p1_thumbnail.jpg" alt="Sport Leather Jacket" id="qv_1" /></a></div>
        <div class="name"><a href="Sport-Leather-Jacket_p_1.html">Sport Leather Jacket</a></div>
        <div class="stars">
        <!--START: product_review--> 
        <!--START: product_review_average-->
        ...
        <div class="status"><!--START: product_availability-->In Stock. <!--END: product_availability--><!--START: freeshippingblock-->Free Shipping.<!--END: freeshippingblock--></div>
        <div class="action">
            <input type="button" value="Add To Cart" onclick="window.location = 'Sport-Leather-Jacket_p_1.html?quick=1&amp;item_id=1'" class="btn" onmouseover="this.className='btn_over'" onmouseout="this.className='btn'" />
        </div>
    <div class="clear"></div>
    </div>
    </div><div class="product-container last-item">
    <div class="product-item item-template-0 alternative">
        <div class="img"><a href="Retro-Mate-Leather-Cut_p_2.html"><img src="assets/images/mancoat_thumbnail.jpg" alt="Retro Mate Leather Cut" id="qv_2" /></a></div>
        <div class="name"><a href="Retro-Mate-Leather-Cut_p_2.html">Retro Mate Leather Cut</a></div>
        <div class="stars">
        <!--START: product_review--> 
        <!--START: product_review_average-->
            <img src="assets/templates/common-html5/images/star0.png" alt="Average Rating" /><span>(0)</span>
        ...
        <div class="status"><!--START: product_availability-->In Stock. <!--END: product_availability--></div>
        <div class="action">
            <input type="button" value="Add To Cart" onclick="window.location = 'view_cartd842.html?quick=1&amp;item_id=2'" class="btn" onmouseover="this.className='btn_over'" onmouseout="this.className='btn'" />
        </div>
    <div class="clear"></div>
    </div>
  ...
  <!--END: ITEMS--> 
    ...
    <aside id="rightBar" class="rightBar">
      <div class="column" id="column2"> 
        ...
        <!--START: RIGHT_BANNER--><!--END: RIGHT_BANNER--> 
