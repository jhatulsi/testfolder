...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 30, 2017 at 02:21 PM
...
(6, 'usertwo@gmail.com', 'usertwo111', 1),
...
INSERT INTO `vendorreg` (`vReg_id`, `name`, `comp_name`, `state`, `country`, `gender`, `is_active`, `email`) VALUES
(1, 'TULSI', 'Company', 'delhi', 'india', 'female', 1, 'tulsi@gmail.com'),
(2, 'TULSI', 'Company', 'delhi', 'india', 'female', 1, 'userone@gmail.com'),
(3, 'TULSI', 'Company', 'Delhi', 'india', '', 1, 'usertwo@gmail.com');
...
--
ALTER TABLE `vendorreg`
  MODIFY `vReg_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
